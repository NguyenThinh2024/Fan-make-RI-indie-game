...
public class DatabaseManager : MonoBehaviour
{
    ...
    public void PrintDatabaseStats()
    {
        ...
        Debug.Log($"Total Objects: {guDatabase.Length + itemDatabase.Length + recipeDatabase.Length + enemyDatabase.Length + aptitudeDatabase.Length + apertureDatabase.Length}");
    }
